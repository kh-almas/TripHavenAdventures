                    ...
                    products?.map((info, index) =>
                        <div key={index} className="max-w-sm mx-auto bg-white rounded-md shadow-md overflow-hidden w-full">
                            ...
                            <div className="px-4 py-3">
                                <h2 className="text-xl font-semibold text-gray-800">{info?.placeName}</h2>
                                <p className="text-gray-600">Category: {info?.category}</p>
                                <p className="text-gray-700 mt-2">{info?.attraction}</p>
